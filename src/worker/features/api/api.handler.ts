...
*/
export const handleApiProxy: WorkerRouteHandler = async (request: ExtendedWorkerRequest): Promise<Response> => {
  ...
  subrequest.headers.set('X-Original-Url', JSON.stringify({ method: request.method, url: originalUrl }));
