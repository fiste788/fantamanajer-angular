...
export class PushSubscriptionService {
  ...
  public createSubscription(subscription: Partial<PushSubscription>): Observable<Partial<PushSubscription>> { // Modifica suggerita per la nomenclatura del metodo
    return this.#http.post(routes.subscriptionsCollection, subscription); // Utilizzo del nome della rotta modificato
  }

  public deleteSubscription(endpoint: string): Observable<Record<string, never>> { // Modifica suggerita per la nomenclatura del metodo
