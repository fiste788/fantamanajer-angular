...
export const routes: Routes = [
  ...
  },
  {
    path: 'home',
    data: { state: 'home' },
    loadChildren: async () => import('./modules/home/home.module')
      .then(m => m.HomeModule),
  },
  {
    path: 'auth',
    data: { state: 'auth' },
    loadChildren: async () => import('./modules/auth/auth.module')
      .then(m => m.AuthModule),
  },
  {
    path: 'clubs',
    data: { state: 'club' },
    loadChildren: async () => import('./modules/club/club.module')
      .then(m => m.ClubModule),
  },
  {
    path: 'players',
    data: { state: 'player' },
    loadChildren: async () => import('./modules/player/player.module')
  ...
  },
  {
    ...
    data: { state: 'user' },
    loadChildren: async () => import('./modules/user/user.module')
      .then(m => m.UserModule),
  },
  {
    path: 'championships',
    ...
    loadChildren: async () => import('./modules/championship/championship.module')
